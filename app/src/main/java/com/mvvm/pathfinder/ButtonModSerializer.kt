...
class ButtonModSerializer : JsonSerializer<ButtonMod> {
    override fun serialize(
        ...
        jsonObject.add("longPress", context?.serialize(src?.longPress))
        jsonObject.add("increment", context?.serialize(src?.increment))
        jsonObject.add("loop", context?.serialize(src?.loop))
        jsonObject.add("limit", context?.serialize(src?.limit))
        return jsonObject
    }
}